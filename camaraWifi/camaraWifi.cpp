...
const char *ssid_Router     = "xxxxxxxxxx";  //input your wifi name
const char *password_Router = "xxxxxxxxxxxxx";  //input your wifi passwords
camera_config_t config;

IPAddress local_IP(192,168,1,200);   // IP fija
IPAddress gateway(192,168,1,254);    // IP del modem Telmex
